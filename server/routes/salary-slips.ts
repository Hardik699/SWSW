...
<tr><td class="label">Sp. Allowance</td><td>${formatCurrency(salaryRecord.specialAllowance || 0)}</td><td>${formatCurrency(salaryRecord.specialAllowanceEarned || 0)}</td><td class="label">${(salaryRecord.retention || 0) < 0 ? 'Deduction' : 'Retention'}</td><td>${formatCurrency(salaryRecord.retention || 0)}</td></tr>
